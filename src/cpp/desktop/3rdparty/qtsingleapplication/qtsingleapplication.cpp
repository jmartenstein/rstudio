...
void QtSingleApplication::initInstanceTracking(const QString &appId)
{
    actWin = 0;
...
QtSingleApplication::QtSingleApplication(int &argc, char **argv, bool GUIenabled)
    : QApplication(argc, argv, GUIenabled), peer(NULL), actWin(NULL)
{
}
...
QtSingleApplication::QtSingleApplication(const QString &appId, int &argc, char **argv)
    : QApplication(argc, argv), peer(NULL), actWin(NULL)
{
}
...
QtSingleApplication::QtSingleApplication(int &argc, char **argv, Type type)
    : QApplication(argc, argv, type), peer(NULL), actWin(NULL)
{
}
...
QtSingleApplication::QtSingleApplication(Display* dpy, Qt::HANDLE visual, Qt::HANDLE cmap)
    : QApplication(dpy, visual, cmap), peer(NULL), actWin(NULL)
{
}
...
QtSingleApplication::QtSingleApplication(Display *dpy, int &argc, char **argv, Qt::HANDLE visual, Qt::HANDLE cmap)
    : QApplication(dpy, argc, argv, visual, cmap), peer(NULL), actWin(NULL)
{
}
...
{
    return peer != NULL && peer->isClient();
}
